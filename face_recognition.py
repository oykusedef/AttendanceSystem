...
class Face_Recognition:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="FACE RECOGNITION", font=("Calibri", 35, "bold"), bg="black", fg="purple")
        title_lbl.place(x=0, y=0, width=1530, height=55)

        img_top = Image.open(r"college_images/facedetector.jpeg")
        ...
        img_bottom = Image.open(r"college_images/face_recognition_identification.jpg")
        ...
        b1_1 = Button(f_lbl, text="Face Recognition", command=self.face_recog, cursor="hand2", font=("Calibri", 18, "bold"), bg="purple", fg="white")
