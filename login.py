...
class Login_Window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\login.jpg")
        ...
        img1 = Image.open(r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\user.webp")
        ...
        get_str = Label(frame, text="Get Started", font=(
            "Calibri", 20, "bold"), fg="white", bg="black")
        get_str.place(x=95, y=100)

        # label
        username = lbl = Label(frame, text="Username", font=(
            "Calibri", 15, "bold"), fg="white", bg="black")
        ...
        self.txtpass = ttk.Entry(frame, font=(
            "Calibri", 15, "bold"), show='*')
        self.txtpass.place(x=40, y=250, width=270)

        # =====icon images=========
        img2 = Image.open(r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\user.webp")
        base_size = 25
        ...
        img3 = Image.open(r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\locicon.png")
        base_size = 25
        ...
        loginbtn = Button(frame, command=self.login, text="Login", font=(
            "Calibri", 15, "bold"), bd=3, relief=RIDGE, fg="white", bg="red", activeforeground="white", activebackground="red")
        loginbtn.place(x=110, y=300, width=120, height=35)

        # registerbutton
        registerbtn = Button(frame, text="Create new account", command=self.register_window, font=(
            "Calibri", 10, "bold"), borderwidth=0, fg="white", bg="black", activeforeground="white", activebackground="black")
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            conn = mysql.connector.connect(
                host="localhost", user="root", password="kk123456.", database="face_recognizer")
        ...
        if self.txtuser.get() == "":
            ...
            if row is None:
                ...
                l = Label(self.root2, text="Forgot Password", font=(
                    "Calibri", 15, "bold"), fg="red", bg="white")
                ...
                btn = Button(self.root2, text="Reset", command=self.reset_pass, font=(
                    "Calibri", 15, "bold"), bg="green", fg="white")
...
class Register:
    def __init__(self, root):
        ...
        # =========== buttons================
        img = Image.open(r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\registerbtn.jpg")
        ...
        img1 = Image.open(r"C:\Users\oztur\PycharmProjects\pythonProject2\college_images\loginnow.jpg")
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        title_lbl = Label(bg_img, text="FACE RECOGNITION AUTOMATED ATTENDANCE SYSTEM",
                          font=("Calibri", 35, "bold"), bg="black", fg="purple")
        ...
        b1_1 = Button(bg_img, text="Student Details", command=self.student_details, cursor="hand2", font=("Calibri", 15, "bold"), bg="purple", fg="white")
        ...
        b1_1 = Button(bg_img, text="Face Detector", cursor="hand2", command=self.face_data, font=("Calibri", 15, "bold"), bg="purple", fg="white")
        ...
        b1_1 = Button(bg_img, text="Attendance", cursor="hand2", command=self.attendance_data, font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
        ...
        b1_1 = Button(bg_img, text="Help Desk", cursor="hand2", command=self.help_data, font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
        ...
        b1_1 = Button(bg_img, text="Train Data", cursor="hand2", command=self.train_data, font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
        ...
        b1_1 = Button(bg_img, text="Photos", cursor="hand2", font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
        ...
        b1_1 = Button(bg_img, text="Developer", cursor="hand2", command=self.developer_data, font=(
            "Calibri", 15, "bold"), bg="purple", fg="white")
        ...
        b1_1 = Button(bg_img, text="Exit", cursor="hand2", command=self.iExit, font=("Calibri", 15, "bold"), bg="purple", fg="white")
