...
class Attendance:
    def __init__(self, root):
        ...
        # Left label frame
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Attendance Details", font=("Calibri", 12, "bold"))
        ...
        attendanceId_label = Label(left_inside_frame, text="AttendanceId:", font=(
            "Calibri", 13, "bold"), bg="white")
        attendanceId_label.grid(row=0, column=0, padx=10, sticky=W)

        attendanceID_entry = ttk.Entry(
            left_inside_frame, width=20, textvariable=self.var_atten_id, font=("Calibri", 13, "bold"))
        ...
        save_btn = Button(btn_frame, text="Import csv", command=self.importCsv, width=19, font=(
            "Calibri", 13, "bold"), bg="purple", fg="white")
        save_btn.grid(row=0, column=0)

        update_btn = Button(btn_frame, text="Export csv", command=self.exportCsv, width=19, font=(
            "Calibri", 13, "bold"), bg="purple", fg="white")
        ...
        reset_btn = Button(btn_frame, text="Reset", width=19, command=self.reset_data, font=(
            "Calibri", 13, "bold"), bg="purple", fg="white")
        ...
        Right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                 text="Attendance Details", font=("Calibri", 12, "bold"))
