...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b1_1 = Button(bg_img, text="Help Center", cursor="hand2", command=self.help_data, font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
        ...
        b1_1 = Button(bg_img, text="Exit", cursor="hand2", command=self.iExit, font=("Calibri", 15, "bold"), bg="purple",
                      fg="white")
